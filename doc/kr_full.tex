...
\item \textit{János elõttem evett.} \label{5} 
...
In this case, the possibility of suffixing the postposition with the derivational suffix '\textit{-i}'  (e.g.. \textit{*elõttemi}) has to be excluded,
 because the postposition in itself can be suffixed by '\textit{-i}'  (\textit{elõtti}: \verb|POSTP[ATTRIB]/ADJ| 'sg in front of').
